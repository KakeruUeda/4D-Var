...
def plot_mae_comparison(mae_values_44x16x16, mae_values_22x8x8, mae_values_66x24x24, filename):
    plt.figure(figsize=(5, 2.5))
    x_values_66x24x24 = range(len(mae_values_66x24x24))
    x_values_44x16x16 = range(len(mae_values_44x16x16))
    x_values_22x8x8 = range(len(mae_values_22x8x8))
    
    plt.plot(x_values_66x24x24, mae_values_66x24x24, 
...
opt_folder_66x24x24 = '../4dvar/output/stenosis_ave_66x24x24/optimized'
ref_folder_66x24x24 = '../../direct/voxelDataCreation/output/stenosis_22x8x8/bin'
mae_values_66x24x24 = process_folder(opt_folder_66x24x24, ref_folder_66x24x24)

opt_folder_44x16x16 = '../4dvar/output/stenosis_ave_44x16x16/optimized'
ref_folder_44x16x16 = '../../direct/voxelDataCreation/output/stenosis_44x16x16/bin'
mae_values_44x16x16 = process_folder(opt_folder_44x16x16, ref_folder_44x16x16)

opt_folder_22x8x8 = '../4dvar/output/stenosis_ave_22x8x8/optimized'
ref_folder_22x8x8 = '../../direct/voxelDataCreation/output/stenosis_22x8x8/bin'
mae_values_22x8x8 = process_folder(opt_folder_22x8x8, ref_folder_22x8x8)

for i, mae in enumerate(mae_values_66x24x24):
    print(f"Time Step {i} (66x24x24): MAE = {mae}")
for i, mae in enumerate(mae_values_44x16x16):
    print(f"Time Step {i} (4416x16): MAE = {mae}")
for i, mae in enumerate(mae_values_22x8x8):
    print(f"Time Step {i} (22x8x8): MAE = {mae}")

plot_mae_comparison(mae_values_44x16x16, mae_values_22x8x8, mae_values_66x24x24, 'ave_mae_comparison.png')
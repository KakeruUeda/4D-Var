...
mri_path = '../../4dvar/output/Ubend_inlet_half_space_wave_time_wave_reg1e-1/optimized/'  
cfd_path = '../../4dvar/output/Ubend_inlet_half_space_wave_time_wave_reg1e-1/optimized/'  

output_folder = "Ubend_inlet_DA"

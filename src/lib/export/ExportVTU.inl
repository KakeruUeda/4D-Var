...
#ifndef EXPORT_VTU_INL_H
#define EXPORT_VTU_INL_H
...
template <typename T>
void EXPORT::exportScalarPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, std::vector<T> &p)
{
  FILE *fp;
...
template <typename T>
void EXPORT::exportVectorPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, std::vector<std::vector<T>> &p)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportScalarCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, std::vector<T> &c)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportVectorCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, std::vector<std::vector<T>> &c)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportScalarPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array1D<T> &p)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportVectorPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array2D<T> &p)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportScalarCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array1D<T> &c)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportVectorCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array2D<T> &c)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportScalarPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array2D<T> &p, const int t)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
void EXPORT::exportVectorPointDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array3D<T> &p, const int t)
{
  ...
  for(int in = 0; in < node.nNodesGlobal; in++) {
    ...
    num++;
    data_point_d3[num] = (float)p(t, in, 2);
    num++;
  }
  size = sizeof(float) * node.nNodesGlobal * 3;
  ofs.write((char *)&size, sizeof(size));
...
template <typename T>
void EXPORT::exportScalarCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array2D<T> &c, const int t)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
...
template <typename T>
void EXPORT::exportVectorCellDataVTU(const std::string &file, const char *dataName, Node &node, Cell &cell, Array3D<T> &c, const int t)
{
  FILE *fp;
  if((fp = fopen(file.c_str(), "w")) == NULL) {
    std::cerr << file << " open error" << std::endl;
  ...
  num = 0;
  for(int ic = 0; ic < cell.nCellsGlobal; ic++) {
    data_cell_d3[num] = (float)c(t, ic, 0);
    num++;
    data_cell_d3[num] = (float)c(t, ic, 1);
    num++;
    data_cell_d3[num] = (float)c(t, ic, 2);
    num++;
  }
  size = sizeof(float) * cell.nCellsGlobal * 3;
  ofs.write((char *)&size, sizeof(size));
